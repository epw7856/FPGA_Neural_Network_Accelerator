...
set DataType000 "[list ap_fixed 26 10 6 0 0 ]"
...
set DataType001 "[list ap_fixed 26 10 6 0 0 ]"
...
set DataType00 [list "DOUBLE" "struct DOUBLE" $structMem00 1 0 $structParameter00 $structArgument00 $NameSpace00 $structIsPacked00]
...
set DataType0 [list "DMA_DATA" "struct DMA_DATA" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
set Port0 [list $PortName0 $Interface0 $DataType0 $Pointer0 $Dims0 $Const0 $Volatile0 $ArrayOpt0]
lappend PortList $Port0
set PortName1 "input_dma_I"
set BitWidth1 "96"
set ArrayOpt1 ""
set Const1 "0"
set Volatile1 "0"
...
set DataType100 "[list ap_fixed 26 10 6 0 0 ]"
...
set DataType101 "[list ap_fixed 26 10 6 0 0 ]"
...
set DataType10 [list "DOUBLE" "struct DOUBLE" $structMem10 1 0 $structParameter10 $structArgument10 $NameSpace10 $structIsPacked10]
...
set DataType1 [list "DMA_DATA" "struct DMA_DATA" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
set Port1 [list $PortName1 $Interface1 $DataType1 $Pointer1 $Dims1 $Const1 $Volatile1 $ArrayOpt1]
lappend PortList $Port1
set PortName2 "input_dma_B"
set BitWidth2 "64"
set ArrayOpt2 ""
set Const2 "0"
set Volatile2 "0"
...
set DataType20 "[list ap_fixed 26 10 6 0 0 ]"
...
set DataType2 [list "DMA_DATA_B" "struct DMA_DATA_B" $structMem2 1 0 $structParameter2 $structArgument2 $NameSpace2 $structIsPacked2]
set Port2 [list $PortName2 $Interface2 $DataType2 $Pointer2 $Dims2 $Const2 $Volatile2 $ArrayOpt2]
lappend PortList $Port2
set PortName3 "output_dma_O"
set BitWidth3 "96"
set ArrayOpt3 ""
set Const3 "0"
set Volatile3 "0"
...
set DataType300 "[list ap_fixed 26 10 6 0 0 ]"
...
set DataType301 "[list ap_fixed 26 10 6 0 0 ]"
...
set DataType30 [list "DOUBLE" "struct DOUBLE" $structMem30 1 0 $structParameter30 $structArgument30 $NameSpace30 $structIsPacked30]
...
set DataType3 [list "DMA_DATA" "struct DMA_DATA" $structMem3 1 0 $structParameter3 $structArgument3 $NameSpace3 $structIsPacked3]
