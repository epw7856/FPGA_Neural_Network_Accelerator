...
#ifndef __top_mul_mul_8s_26dEe__HH__
#define __top_mul_mul_8s_26dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_mul_mul_8s_26dEe) {
    ...
    SC_CTOR(top_mul_mul_8s_26dEe):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
