...
(* CORE_GENERATION_INFO="top,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu9eg-ffvb1156-2-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.748750,HLS_SYN_LAT=9177,HLS_SYN_TPT=none,HLS_SYN_MEM=30,HLS_SYN_DSP=115,HLS_SYN_FF=6051,HLS_SYN_LUT=42581}" *)
...
reg    ap_ready;
reg   [55:0] input_dma_W_V_data_0_data_out;
wire    input_dma_W_V_data_0_vld_in;
wire    input_dma_W_V_data_0_vld_out;
wire    input_dma_W_V_data_0_ack_in;
wire    input_dma_W_V_data_0_ack_out;
reg   [55:0] input_dma_W_V_data_0_payload_A;
reg   [55:0] input_dma_W_V_data_0_payload_B;
...
wire    input_dma_W_V_last_0_ack_out;
...
reg   [55:0] input_dma_I_V_data_0_data_out;
wire    input_dma_I_V_data_0_vld_in;
wire    input_dma_I_V_data_0_vld_out;
wire    input_dma_I_V_data_0_ack_in;
wire    input_dma_I_V_data_0_ack_out;
reg   [55:0] input_dma_I_V_data_0_payload_A;
reg   [55:0] input_dma_I_V_data_0_payload_B;
...
wire    input_dma_I_V_last_0_ack_out;
...
wire    input_dma_B_V_data_V_0_ack_out;
...
wire    input_dma_B_V_last_0_ack_out;
...
reg   [55:0] output_dma_O_V_data_1_data_out;
...
reg   [55:0] output_dma_O_V_data_1_payload_A;
reg   [55:0] output_dma_O_V_data_1_payload_B;
...
wire   [55:0] grp_OFM_STORE_fu_698_output_dma_O_TDATA;
...
#0 ap_reg_grp_Load_Fire_fu_398_ap_start = 1'b0;
#0 ap_reg_grp_OFM_STORE_fu_698_ap_start = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_reg_grp_OFM_STORE_fu_698_ap_start <= 1'b0;
    end else begin
        if ((((tmp_fu_741_p1 == 1'd1) & (1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1)) | ((tmp_fu_741_p1 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1)))) begin
            ap_reg_grp_OFM_STORE_fu_698_ap_start <= 1'b1;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        ...
        grp_OFM_STORE_fu_698_BIAS_V_q0 = 'bx;
    end
end
...
assign grp_Load_Fire_fu_398_ap_start = ap_reg_grp_Load_Fire_fu_398_ap_start;
...
assign grp_OFM_STORE_fu_698_ap_start = ap_reg_grp_OFM_STORE_fu_698_ap_start;
...
assign input_dma_B_V_data_V_0_ack_out = grp_OFM_STORE_fu_698_input_dma_B_TREADY;
...
assign input_dma_B_V_last_0_ack_out = grp_OFM_STORE_fu_698_input_dma_B_TREADY;
...
assign input_dma_I_V_data_0_ack_out = grp_Load_Fire_fu_398_input_dma_I_TREADY;
...
assign input_dma_I_V_last_0_ack_out = grp_Load_Fire_fu_398_input_dma_I_TREADY;
...
assign input_dma_W_V_data_0_ack_out = grp_Load_Fire_fu_398_input_dma_W_TREADY;
...
assign input_dma_W_V_last_0_ack_out = grp_Load_Fire_fu_398_input_dma_W_TREADY;
