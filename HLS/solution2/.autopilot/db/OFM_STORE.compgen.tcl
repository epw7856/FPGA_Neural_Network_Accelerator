...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { output_dma_O_TDATA { O 64 vector } } \
} "
} else {
...
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'input_dma_B_V_data'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename BIAS \
    op interface \
    ports { BIAS_address0 { O 6 vector } BIAS_ce0 { O 1 bit } BIAS_we0 { O 1 bit } BIAS_d0 { O 32 vector } BIAS_q0 { I 32 vector } } \
} "
} else {
